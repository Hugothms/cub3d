...
{
	if (w->s->map[(int)(w->s->pos.x + w->s->dir.x * SPEED_MOVE)][(int)w->s->pos.y] == '0')
		w->s->pos.x += w->s->dir.x * SPEED_MOVE;
	if (w->s->map[(int)w->s->pos.x][(int)(w->s->pos.y + w->s->dir.y * SPEED_MOVE)] == '0')
...
{
	if (w->s->map[(int)(w->s->pos.x + w->s->plane.x * SPEED_MOVE)][(int)w->s->pos.y] == '0')
		w->s->pos.x += w->s->plane.x * SPEED_MOVE;
	if (w->s->map[(int)w->s->pos.x][(int)(w->s->pos.y + w->s->plane.y * SPEED_MOVE)] == '0')
